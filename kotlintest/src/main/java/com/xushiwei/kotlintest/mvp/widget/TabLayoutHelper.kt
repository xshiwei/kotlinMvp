        ...
        try {
            ...
            for (i in 0 until layout!!.childCount) {
                ...
                if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.JELLY_BEAN_MR1) {
                    params.marginStart = ArmsUtils.dip2px(MyApplication.instance.applicationContext, 50f)
                    params.marginEnd = ArmsUtils.dip2px(MyApplication.instance.applicationContext, 50f)
                }
